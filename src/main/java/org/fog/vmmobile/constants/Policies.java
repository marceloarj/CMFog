...
public class Policies {
    ...
    //public static final int CCMFOG = 1;
    //public static final int TCMFOG = 2;
    public static final int CMFOG = 3;
    public static final int MIX = 4;

    public static final int LOWEST_DIST_BW_SMARTTING_SERVERCLOUDLET = 10;
    public static final int LOWEST_DIST_BW_SMARTTING_AP = 20;
    public static final int ILP = 30;

    public static final int FIXED_MIGRATION_POINT = 0;
    public static final int SPEED_MIGRATION_POINT = 1;
    public static final int TIME_MIGRATION_POINT = 2;
